...
INPUT_FILE_NAME = "Global_Missing_Migrants_Dataset.csv"
...
def prepare_message_from_row(row):
    ...
    Year, Origin, IncidentLocation, Dead, Survived, Cause = row
    # use an fstring to create a message from our data
    # notice the f before the opening quote for our string?
    fstring_message = f"A migration incident occurred in {Year}. Migrants were from {Origin}. The incident occured in {IncidentLocation}. {Dead} died and {Survived} survived. The cause was {Cause}"
